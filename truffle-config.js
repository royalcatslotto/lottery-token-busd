...
const fs = require('fs');
const { infuraProjectId, mainnetPrivateKeys, mainnetBkcPrivateKeys, testnetBkcPrivateKeys, privateKeys, etherApiKey, bscApiKey } = JSON.parse(fs.readFileSync('.secret').toString().trim());
